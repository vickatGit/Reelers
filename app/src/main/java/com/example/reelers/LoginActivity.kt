...
class LoginActivity : AppCompatActivity() {
  ...
  private fun initialiseViews() {
    ...
    passwordQuestion.setTypeface(ResourcesCompat.getFont(this,R.font.circular_std_bold))
    login.setTypeface(ResourcesCompat.getFont(this,R.font.circular_std_medium))
